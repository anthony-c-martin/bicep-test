...
The validator restores and builds each local library, then invokes Jest, MSTest, `go test`, and Pester. It exits with a nonzero status if any sample cannot compile or does not pass.