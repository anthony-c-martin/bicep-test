...
description: 'Add or extend a bicep-test framework capability across Node, C#, Go, and PowerShell. Use when implementing new snapshot behavior, options, result data, lifecycle operations, or other public features that require idiomatic APIs, cross-language conformance tests, shared Bicep samples, regenerated public API baselines, language docs, and an abstract README explanation.'
...
- Node, C#, Go, and PowerShell expose equivalent behavior through idiomatic public APIs.
...
Update `README.md` separately. Describe the capability once in language-neutral, user-centered terms. Explain what it enables and its major behavioral constraints without listing language-specific method names or duplicating all four examples.
